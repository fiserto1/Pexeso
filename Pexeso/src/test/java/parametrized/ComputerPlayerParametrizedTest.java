...
public class ComputerPlayerParametrizedTest {
    ...
    public ComputerPlayerParametrizedTest(String name, String playerNumber, String isExceptionExpected) {
        this.name = name;
    ...
    public void testCreateComputerPlayerParametrized() {
        ...
        ComputerPlayer computerPlayer = new ComputerPlayer(name, null, playerNumber);
